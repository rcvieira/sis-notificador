...
usuario = passStore.SIS_USER
senha = passStore.get_pass()
...
url_estasemana = url_sis + '/en-GB/School-Locations/Brasilia/Parents-Section/Current-Information/Parent-Letters'
...
if pdf_novo:
    ...
    link = '<a href="{url_pdf}">CLIQUE AQUI para ver o Esta Semana de {data}</a>'.format(url_pdf=url_pdf, data=dt.strftime('%d/%m/%Y'))
